...
values
  ...
  ('07400000-0000-4000-8000-000000000004','07200000-0000-4000-8000-000000000001','07300000-0000-4000-8000-000000000004','PROJECT_MEMBER','2026-01-01T00:00:00Z',null,'07100000-0000-4000-8000-000000000001','Initial','2026-01-01T00:00:00Z'),
  ('07400000-0000-4000-8000-000000000005','07200000-0000-4000-8000-000000000001','07300000-0000-4000-8000-000000000005','PROJECT_MEMBER','2026-01-01T00:00:00Z',null,'07100000-0000-4000-8000-000000000001','Initial','2026-01-01T00:00:00Z'),
  ('07400000-0000-4000-8000-000000000006','07200000-0000-4000-8000-000000000001','07300000-0000-4000-8000-000000000006','PROJECT_MEMBER','2026-01-01T00:00:00Z',null,'07100000-0000-4000-8000-000000000001','Initial','2026-01-01T00:00:00Z'),
...
-- Ordinary replacement with canonical role coverage.
...
begin
  ...
  if (
    ...
    where correlation_id =
      '07500000-0000-4000-8000-000000000003'
      and event_type in ('ProjectRoleAssigned', 'ProjectRoleRevoked')
  ) <> 2 then
    raise exception 'Canonical ordinary replacement cardinality invalid';
  end if;
