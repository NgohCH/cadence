...
values
  ...
  ('07d40000-0000-4000-8000-000000000004','07d20000-0000-4000-8000-000000000001','07d30000-0000-4000-8000-000000000004','PROJECT_MEMBER','2026-08-01T00:00:00Z',null,'07d10000-0000-4000-8000-000000000001','VS002-07D initial ordinary','2026-08-01T00:00:00Z'),
  ('07d40000-0000-4000-8000-000000000005','07d20000-0000-4000-8000-000000000001','07d30000-0000-4000-8000-000000000005','PROJECT_MEMBER','2026-08-01T00:00:00Z',null,'07d10000-0000-4000-8000-000000000001','VS002-07D initial ordinary','2026-08-01T00:00:00Z'),
  ('07d40000-0000-4000-8000-000000000006','07d20000-0000-4000-8000-000000000001','07d30000-0000-4000-8000-000000000006','PROJECT_MEMBER','2026-08-01T00:00:00Z',null,'07d10000-0000-4000-8000-000000000001','VS002-07D initial ordinary','2026-08-01T00:00:00Z'),
...
do $$
begin
  if (select count(*) from public.domain_events where project_id = '07d20000-0000-4000-8000-000000000001') <> 9 then
    raise exception 'Expected nine pre-expiry domain events';
  end if;

  if (select count(*) from public.domain_event_deliveries d join public.domain_events e on e.id = d.event_id where e.project_id = '07d20000-0000-4000-8000-000000000001' and d.consumer_name = 'audit.domain-events.v1') <> 9 then
    raise exception 'Expected nine pre-expiry Audit deliveries';
  end if;
